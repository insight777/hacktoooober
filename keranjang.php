						...
						<br>
							...
							<tbody>
								...
								<tr>
									...
									<th> 
										<p align="center"><a href="hapus.php?id=<?php echo $ID ?>" class="btn btn-danger btn-xs">Hapus</a></p>
									</th>
								</tr>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<span class="copyright">
								...
								Copyright &copy;RoboStore<script>document.write(new Date().getFullYear());</script> All rights reserved | RoboStore is a company under GESANG TECHNOLOGY.corp&trade;
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</span>
						</div>
					</div>
